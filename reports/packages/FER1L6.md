# FER1L6 — candidate package

**CAR-PDAC-001** · `Q2WGJ9` · decision **ADVANCE** · PASSED_ALL_GATES · INNOVATIVE_DESIGN · on the Pareto front · position 1 of 5 · PACKAGED
...
| objective | value |
| --- | --- |
| attractiveness | 0.5023 |
| safety_margin | -0.1381 |
| binder_count | 0 |
| cleanliness | 0 |
...
| --- | --- | --- | --- | --- |
| tumour_coverage | 0.18 | MEASURED | 0.2978 | stage3.patient_prevalence |
| malignant_specificity | 0.16 | MEASURED | 0.9522 | stage3.malignant_vs_stroma |
| normal_tissue_safety | 0.16 | MEASURED | 0.1769 | stage9 residual margin below the applied ceiling 0.35 |
...
The amino-acid sequence and the nucleotide map are in `FER1L6.json` beside this file. The DNA is a map under one fixed codon per residue, so the boundaries above are exact. It is not a codon-optimised ordering sequence.
...
| confidence | 1.0 |
| normal-tissue risk | 0.2881 (lung) |
...
Risk 0.2880651846789378 on lung, ahead of the next organ by 0.012025968139755205, across 20 organs that scored.

| organ | weighted | score | tier | arm | staining | transcript |
| --- | --- | --- | --- | --- | --- | --- |
| lung | 0.2881 | 0.2881 | 1 | STAINING | bronchus Low 0.2881 | Lung 0.0 TPM 0.0033 |
| gi_tract | 0.276 | 0.4601 | 2 | STAINING | small intestine High 0.4601 | Stomach_Mixed_Cell 4.6 TPM 0.2487 |
| endocrine | 0.1728 | 0.2881 | 2 | STAINING | adrenal gland Low 0.2881 | Thyroid 0.7 TPM 0.0754 |
| muscle | 0.1728 | 0.2881 | 2 | STAINING | skeletal muscle Low 0.2881 | Muscle_Skeletal 0.0 TPM 0.0032 |
| reproductive | 0.0864 | 0.2881 | 3 | STAINING | endometrium 2 Low 0.2881 | Testis 5.8 TPM 0.2768 |
| liver | 0.0544 | 0.0544 | 1 | BASELINE | liver Not detected 0.0000 | Liver_Portal_Tract 0.5 TPM 0.0544 |
| kidney | 0.0426 | 0.0426 | 1 | BASELINE | kidney Not detected 0.0000 | Kidney_Cortex 0.3 TPM 0.0426 |
| brain | 0.0044 | 0.0044 | 1 | BASELINE | caudate Not detected 0.0000 | Brain_Anterior_cingulate_cortex_BA24 0.0 TPM 0.0044 |
| heart | 0.0043 | 0.0043 | 1 | BASELINE | heart muscle Not detected 0.0000 | Heart_Left_Ventricle 0.0 TPM 0.0043 |
| vascular | 0.0022 | 0.0022 | 1 | BASELINE | NOT_MEASURED | Artery_Coronary 0.0 TPM 0.0022 |
| salivary | 0.0021 | 0.007 | 3 | BASELINE | salivary gland Not detected 0.0000 | Minor_Salivary_Gland 0.0 TPM 0.0070 |
| nerve | 0.0013 | 0.0022 | 2 | BASELINE | NOT_MEASURED | Nerve_Tibial 0.0 TPM 0.0022 |
| bladder | 0.0011 | 0.0019 | 2 | BASELINE | urinary bladder Not detected 0.0000 | Bladder 0.0 TPM 0.0019 |
| adipose | 0.0009 | 0.003 | 3 | BASELINE | adipose tissue Not detected 0.0000 | Adipose_Subcutaneous 0.0 TPM 0.0030 |
| skin | 0.0007 | 0.0024 | 3 | BASELINE | skin 1 Not detected 0.0000 | Skin_Sun_Exposed_Lower_leg 0.0 TPM 0.0024 |
| pancreas | 0.0006 | 0.001 | 2 | BASELINE | pancreas Not detected 0.0000 | Pancreas 0.0 TPM 0.0010 |
| breast | 0.0004 | 0.0014 | 3 | BASELINE | breast Not detected 0.0000 | Breast_Mammary_Tissue 0.0 TPM 0.0014 |
| connective | 0.0 | 0.0 | 3 | STAINING | soft tissue 2 Not detected 0.0000 | NOT_MEASURED |
| marrow_and_blood | 0.0 | 0.0 | 2 | TIED | bone marrow Not detected 0.0000 | Spleen 0.0 TPM 0.0000 |
| mucosa | 0.0 | 0.0 | 2 | STAINING | oral mucosa Not detected 0.0000 | NOT_MEASURED |
...
Stage 5 verdict: **NO_BINDER** · 0 structural entries examined
...
| --- | --- |
| verdict | FLAGGED |
| risk against the applied ceiling | 0.2881 against 0.35 |
| peak organ | lung |
| binder origin | non-human |
| source organism | Mus musculus |
| epitope immunogenicity | NOT_CONNECTED |
| trials naming this symbol | 0, 0 stopped |
...
| antigen-dependent killing | confirm killing requires both the adaptor and FER1L6 | FER1L6-positive and FER1L6-negative lines; for the adaptor design, a no-adaptor arm is the negative control | cytotoxicity and cytokine release | TO_BE_MEASURED | TO_BE_SET_BEFORE_THE_RUN |
| on-target off-tumour check against the declared risk organ | the risk model puts this target's peak normal-tissue signal in lung at 0.2881. That is a prediction from expression data and has not been tested on cells here. | primary cells or organoids from lung | cytotoxicity against the normal-tissue model | TO_BE_MEASURED | TO_BE_SET_BEFORE_THE_RUN |
...
| --- | --- | --- | --- | --- | --- |
| tumour control | whether the design controls a FER1L6-positive tumour | xenograft, line and strain TO_BE_SET · untransduced T cells; receptor without adaptor; receptor with adaptor | tumour burden over time | TO_BE_MEASURED | TO_BE_SET_BEFORE_THE_RUN |
