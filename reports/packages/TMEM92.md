# TMEM92 — candidate package

**CAR-PDAC-003** · `Q6UXU6` · decision **BACKUP** · PASSED_ALL_GATES · INNOVATIVE_DESIGN · dominated · position 3 of 5 · PACKAGED
...
| --- | --- | --- | --- | --- |
| tumour_coverage | 0.18 | MEASURED | 0.8202 | stage3.patient_prevalence |
| malignant_specificity | 0.16 | MEASURED | 0.499 | stage3.malignant_vs_stroma |
...
The amino-acid sequence and the nucleotide map are in `TMEM92.json` beside this file. The DNA is a map under one fixed codon per residue, so the boundaries above are exact. It is not a codon-optimised ordering sequence.
...
Risk 0.2880651846789378 on brain, lung, ahead of the next organ by 0.0, across 20 organs that scored.

| organ | weighted | score | tier | arm | staining | transcript |
| --- | --- | --- | --- | --- | --- | --- |
| brain | 0.2881 | 0.2881 | 1 | STAINING | cerebellum Low 0.2881 | Brain_Spinal_cord_cervical_c-1 0.1 TPM 0.0200 |
| lung | 0.2881 | 0.2881 | 1 | STAINING | bronchus Low 0.2881 | Lung 1.8 TPM 0.1494 |
| gi_tract | 0.2577 | 0.4296 | 2 | BASELINE | duodenum Medium 0.3786 | Stomach_Mucosa 18.4 TPM 0.4296 |
| liver | 0.175 | 0.175 | 1 | BASELINE | liver Not detected 0.0000 | Liver_Mixed_Cell 2.3 TPM 0.1750 |
| marrow_and_blood | 0.1728 | 0.2881 | 2 | STAINING | tonsil Low 0.2881 | Whole_Blood 0.8 TPM 0.0874 |
| mucosa | 0.1728 | 0.2881 | 2 | STAINING | nasopharynx Low 0.2881 | NOT_MEASURED |
| muscle | 0.1728 | 0.2881 | 2 | STAINING | smooth muscle Low 0.2881 | Muscle_Skeletal 0.0 TPM 0.0016 |
| vascular | 0.1284 | 0.1284 | 1 | BASELINE | NOT_MEASURED | Artery_Aorta 1.4 TPM 0.1284 |
| breast | 0.0864 | 0.2881 | 3 | STAINING | breast Low 0.2881 | Breast_Mammary_Tissue 0.2 TPM 0.0279 |
| reproductive | 0.0864 | 0.2881 | 3 | STAINING | epididymis Low 0.2881 | Ovary 1.9 TPM 0.1541 |
| salivary | 0.0864 | 0.2881 | 3 | STAINING | salivary gland Low 0.2881 | Minor_Salivary_Gland 1.7 TPM 0.1430 |
| bladder | 0.065 | 0.1084 | 2 | BASELINE | urinary bladder Not detected 0.0000 | Bladder 1.1 TPM 0.1084 |
| nerve | 0.059 | 0.0984 | 2 | BASELINE | NOT_MEASURED | Nerve_Tibial 1.0 TPM 0.0984 |
| kidney | 0.0497 | 0.0497 | 1 | BASELINE | kidney Not detected 0.0000 | Kidney_Medulla 0.4 TPM 0.0497 |
| pancreas | 0.0212 | 0.0353 | 2 | BASELINE | pancreas Not detected 0.0000 | Pancreas_Mixed_Cell 0.3 TPM 0.0353 |
| skin | 0.0077 | 0.0257 | 3 | BASELINE | skin 1 Not detected 0.0000 | Skin_Not_Sun_Exposed_Suprapubic 0.2 TPM 0.0257 |
| heart | 0.007 | 0.007 | 1 | BASELINE | heart muscle Not detected 0.0000 | Heart_Atrial_Appendage 0.0 TPM 0.0070 |
| adipose | 0.0062 | 0.0206 | 3 | BASELINE | adipose tissue Not detected 0.0000 | Adipose_Subcutaneous 0.2 TPM 0.0206 |
| endocrine | 0.0046 | 0.0076 | 2 | BASELINE | adrenal gland Not detected 0.0000 | Pituitary 0.1 TPM 0.0076 |
...
| antigen-dependent killing | confirm killing requires both the adaptor and TMEM92 | TMEM92-positive and TMEM92-negative lines; for the adaptor design, a no-adaptor arm is the negative control | cytotoxicity and cytokine release | TO_BE_MEASURED | TO_BE_SET_BEFORE_THE_RUN |
...
| --- | --- | --- | --- | --- | --- |
| tumour control | whether the design controls a TMEM92-positive tumour | xenograft, line and strain TO_BE_SET · untransduced T cells; receptor without adaptor; receptor with adaptor | tumour burden over time | TO_BE_MEASURED | TO_BE_SET_BEFORE_THE_RUN |
